...
module.exports = client => {
  ...
  if (!allowedNames.includes(client.user.username.toLowerCase())) {
    console.log(
      `\n${yellow(
        "[Mai-WARN]"
      )} : You are not using Mai-san's name in your bot. This could hinder some of the commands of this bot.`
    );
  }

  client.user.setActivity("Darling in the Franxx", {
    type: "STREAMING",
    url:"https://youtu.be/A4kLcDWBYcQ"
  });
